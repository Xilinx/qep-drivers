...
#define QDMA_REG_GLBL_RNG_SZ_DFLT		256

#define QDMA_REG_C2H_TIMER_CNT_BASE		0xA00
#define QDMA_REG_C2H_TIMER_CNT_COUNT		16
#define QDMA_REG_C2H_TIMER_CNT_DFLT		32

#define QDMA_REG_C2H_CNT_TH_BASE		0xA40
#define QDMA_REG_C2H_CNT_TH_COUNT		16
#define QDMA_REG_C2H_CNT_TH_DFLT		64

#define QDMA_REG_C2H_BUF_SZ_BASE		0xAB0
#define QDMA_REG_C2H_BUF_SZ_COUNT		16
#define QDMA_REG_C2H_BUF_SZ_DFLT		PAGE_SIZE

#define QDMA_EN_OTN_TX_STATS			0

//TODO COMPLEX_MACRO  should be enclosed in parentheses
#define QEP_STAT(m)                                                           \
	sizeof(((struct qep_priv *)0)->m), offsetof(struct qep_priv, m)
...
static const struct qep_stats qep_gstrings_stats[] = {
	{ "rx_bytes", QEP_STAT(stats.rx_bytes) },
	{ "rx_mac_bytes", QEP_STAT(stats.rx_mac_bytes) },
	{ "rx_good_bytes", QEP_STAT(stats.rx_good_bytes) },
	{ "rx_packets", QEP_STAT(stats.rx_packets) },
	{ "rx_mac_packets", QEP_STAT(stats.rx_mac_packets) },
	{ "rx_good_pkts", QEP_STAT(stats.rx_good_pkts) },
	{ "rx_unicast_pkts", QEP_STAT(stats.rx_unicast_pkts) },
	{ "rx_multicast_pkts", QEP_STAT(stats.rx_multicast_pkts) },
	{ "rx_broadcast_pkts", QEP_STAT(stats.rx_broadcast_pkts) },
	{ "rx_pause_pkts", QEP_STAT(stats.rx_pause_pkts) },
	{ "rx_vlan_tagged_pkts", QEP_STAT(stats.rx_vlan_tagged_pkts) },
	{ "rx_priority_pause_pkts", QEP_STAT(stats.rx_priority_pause_pkts) },

	{ "rx_bad_fcs_pkts", QEP_STAT(stats.rx_bad_fcs_pkts) },
	{ "rx_bad_code_pkts", QEP_STAT(stats.rx_bad_code_pkts) },
	{ "rx_too_long_pkts", QEP_STAT(stats.rx_too_long_pkts) },
	{ "rx_oversized_pkts", QEP_STAT(stats.rx_oversized_pkts) },
	{ "rx_jabber_pkts", QEP_STAT(stats.rx_jabber_pkts) },
	{ "rx_undersized_pkts", QEP_STAT(stats.rx_undersized_pkts) },
	{ "rx_frag_pkts", QEP_STAT(stats.rx_frag_pkts) },
	{ "rx_stomped_fcs_pkts", QEP_STAT(stats.rx_stomped_fcs_pkts) },

	{ "rx_range_error_pkts", QEP_STAT(stats.rx_range_error_pkts) },
	{ "rx_truncated_pkts", QEP_STAT(stats.rx_truncated_pkts) },
	{ "rx_hist_less_64_pkts", QEP_STAT(stats.rx_hist_less_64_pkts) },
	{ "rx_hist_64_pkts", QEP_STAT(stats.rx_hist_64_pkts) },
	{ "rx_hist_65_127_pkts", QEP_STAT(stats.rx_hist_65_127_pkts) },
	{ "rx_hist_128_255_pkts", QEP_STAT(stats.rx_hist_128_255_pkts) },
	{ "rx_hist_256_511_pkts", QEP_STAT(stats.rx_hist_256_511_pkts) },
	{ "rx_hist_512_1023_pkts", QEP_STAT(stats.rx_hist_512_1023_pkts) },
	{ "rx_hist_1024_1518_pkts", QEP_STAT(stats.rx_hist_1024_1518_pkts) },
	{ "rx_hist_1519_1522_pkts", QEP_STAT(stats.rx_hist_1519_1522_pkts) },
	{ "rx_hist_1523_1548_pkts", QEP_STAT(stats.rx_hist_1523_1548_pkts) },
	{ "rx_hist_1549_2047_pkts", QEP_STAT(stats.rx_hist_1549_2047_pkts) },
	{ "rx_hist_2048_4095_pkts", QEP_STAT(stats.rx_hist_2048_4095_pkts) },
	{ "rx_hist_4096_8191_pkts", QEP_STAT(stats.rx_hist_4096_8191_pkts) },
	{ "rx_hist_8192_9215_pkts", QEP_STAT(stats.rx_hist_8192_9215_pkts) },
	{ "rx_hist_greter_eq_9216_pkts",
	  QEP_STAT(stats.rx_hist_greter_eq_9216_pkts) },

	{ "tx_bytes", QEP_STAT(stats.tx_bytes) },
	{ "tx_mac_bytes", QEP_STAT(stats.tx_mac_bytes) },
	{ "tx_good_bytes", QEP_STAT(stats.tx_good_bytes) },
	{ "tx_packets", QEP_STAT(stats.tx_packets) },
	{ "tx_mac_packets", QEP_STAT(stats.tx_mac_packets) },
	{ "tx_good_pkts", QEP_STAT(stats.tx_good_pkts) },
	{ "tx_unicast_pkts", QEP_STAT(stats.tx_unicast_pkts) },
	{ "tx_multicast_pkts", QEP_STAT(stats.tx_multicast_pkts) },
	{ "tx_broadcast_pkts", QEP_STAT(stats.tx_broadcast_pkts) },
	{ "tx_pause_pkts", QEP_STAT(stats.tx_pause_pkts) },
	{ "tx_vlan_tagged_pkts", QEP_STAT(stats.tx_vlan_tagged_pkts) },
	{ "tx_priority_pause_pkts", QEP_STAT(stats.tx_priority_pause_pkts) },

	{ "tx_bad_fcs_pkts", QEP_STAT(stats.tx_bad_fcs_pkts) },
#if QDMA_EN_OTN_TX_STATS
	{ "tx_bad_code_pkts", QEP_STAT(stats.tx_bad_code_pkts) },
	{ "tx_too_long_pkts", QEP_STAT(stats.tx_too_long_pkts) },
	{ "tx_oversized_pkts", QEP_STAT(stats.tx_oversized_pkts) },
	{ "tx_jabber_pkts", QEP_STAT(stats.tx_jabber_pkts) },
	{ "tx_undersized_pkts", QEP_STAT(stats.tx_undersized_pkts) },
	{ "tx_frag_pkts", QEP_STAT(stats.tx_frag_pkts) },
	{ "tx_stomped_fcs_pkts", QEP_STAT(stats.tx_stomped_fcs_pkts) },
#endif
	{ "tx_frame_error_pkts", QEP_STAT(stats.tx_frame_error_pkts) },
	{ "tx_hist_less_64_pkts", QEP_STAT(stats.tx_hist_less_64_pkts) },
	{ "tx_hist_64_pkts", QEP_STAT(stats.tx_hist_64_pkts) },
	{ "tx_hist_65_127_pkts", QEP_STAT(stats.tx_hist_65_127_pkts) },
	{ "tx_hist_128_255_pkts", QEP_STAT(stats.tx_hist_128_255_pkts) },
	{ "tx_hist_256_511_pkts", QEP_STAT(stats.tx_hist_256_511_pkts) },
	{ "tx_hist_512_1023_pkts", QEP_STAT(stats.tx_hist_512_1023_pkts) },
	{ "tx_hist_1024_1518_pkts", QEP_STAT(stats.tx_hist_1024_1518_pkts) },
	{ "tx_hist_1519_1522_pkts", QEP_STAT(stats.tx_hist_1519_1522_pkts) },
	{ "tx_hist_1523_1548_pkts", QEP_STAT(stats.tx_hist_1523_1548_pkts) },
	{ "tx_hist_1549_2047_pkts", QEP_STAT(stats.tx_hist_1549_2047_pkts) },
	{ "tx_hist_2048_4095_pkts", QEP_STAT(stats.tx_hist_2048_4095_pkts) },
	{ "tx_hist_4096_8191_pkts", QEP_STAT(stats.tx_hist_4096_8191_pkts) },
	{ "tx_hist_8192_9215_pkts", QEP_STAT(stats.tx_hist_8192_9215_pkts) },
	{ "tx_hist_greter_eq_9216_pkts",
	  QEP_STAT(stats.tx_hist_greter_eq_9216_pkts) },
};
			 ...
			 void *p)
{
	u32 *regs_buff = p;
	struct qep_priv *xpriv = netdev_priv(netdev);
	unsigned int i = 0, reg = 0, reg_idx = 0;
	...
	for (i = 0; i < QDMA_REG_GLBL_RNG_SZ_COUNT; i++, reg += 4) {
		regs_buff[reg_idx++] = qdma_device_read_config_register(
			xpriv->dev_handle, reg);
	}
	...
	/*Update the len macro if adding more registers*/
}
			     ...
			     struct ethtool_channels *ch)
{
	...
	ch->max_other = 0;
	ch->max_combined = 0;
	ch->rx_count = xpriv->num_queues;
	ch->tx_count = xpriv->num_queues;
	ch->other_count = 0;
	ch->combined_count = 0;
}
			    ...
			    struct ethtool_channels *ch)
{
	...
	xpriv->num_queues = ch->rx_count;

	netif_set_real_num_tx_queues(netdev, xpriv->num_queues);
	netif_set_real_num_rx_queues(netdev, xpriv->num_queues);
...
{
	u8 *stat_string;
	u64 val[QEP_GLOBAL_STATS_LEN];
	char *p;
	int i;

	stat_string = kmalloc(QEP_GLOBAL_STATS_LEN * ETH_GSTRING_LEN,
				GFP_KERNEL);
...
#if QDMA_EN_OTN_TX_STATS
	stats->tx_bad_code_pkts +=
		xcmac_get_tx_bad_64b66b_code_count(&xpriv->cmac_instance);
	stats->tx_too_long_pkts += tx_malformed.toolong_count;
	stats->tx_oversized_pkts += tx_malformed.oversize_count;
	stats->tx_jabber_pkts += tx_malformed.jabber_count;
	stats->tx_undersized_pkts += tx_malformed.under_size_count;
	stats->tx_frag_pkts += tx_malformed.fragment_count;
	stats->tx_stomped_fcs_pkts += tx_malformed.stomped_fcs_count;
#endif
