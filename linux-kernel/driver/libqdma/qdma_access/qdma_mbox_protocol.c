				   ...
				   struct qdma_descq_sw_ctxt *sw_ctxt)
{
	...
	if (!qctxt || !sw_ctxt)
		return -QDMA_MBOX_ERR_INVALID_PARAM;
				 ...
				 uint32_t *resp_msg)
{
	...
	break;
	default:
		return -QDMA_MBOX_ERR_INVALID_MSG;
	break;
	}
